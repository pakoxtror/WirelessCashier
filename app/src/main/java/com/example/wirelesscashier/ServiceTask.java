...
public class ServiceTask extends AsyncTask<Void, Void, String> {
    ...
    public ServiceTask(Context ctx, String linkAPI, String card_id, String  establishment_id, String amount ){
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            parametrosPost.put("card_id",card_id);
            parametrosPost.put("establishment",establishment_id);
            parametrosPost.put("amount",amount);
